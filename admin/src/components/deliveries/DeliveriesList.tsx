                  ...
                  <td className="px-6 py-4 text-sm space-x-1">
                    {canMarkPickedUp(delivery) && onMarkPickedUp && (
                      <button
                        ...
                        className="inline-flex items-center p-2 rounded-lg text-green-600 hover:bg-green-50 transition"
                    ...
                    {canEdit && (
                      <button
                        ...
                        className="inline-flex items-center p-2 rounded-lg text-blue-600 hover:bg-blue-50 transition"
                        title="Edit"
                      >
                    ...
                    {isAdmin && (
                      <button
                        ...
                        className="inline-flex items-center p-2 rounded-lg text-red-600 hover:bg-red-50 transition"
                        title="Delete"
                      >
