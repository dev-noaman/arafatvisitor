        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.qrToken.deleteMany({})];
                case 2:
                    _a.sent();
                    console.log('Cleaning up CheckEvents...');
                    return [4 /*yield*/, prisma.checkEvent.deleteMany({})];
                case 3:
                    _a.sent();
                ...
                case 4:
                    ...
                    return [4 /*yield*/, prisma.visit.deleteMany({})];
                case 5:
                    _a.sent();
                ...
                case 7:
                    ...
                    return [4 /*yield*/, prisma.host.deleteMany({})];
                case 8:
                    // We can't just deleteMany if there are other relations, but these are the main ones
                    _a.sent();
