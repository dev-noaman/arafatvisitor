...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        function UsersService_1(prisma, authService) {
            this.prisma = prisma;
            this.authService = authService;
        }
        UsersService_1.prototype.create = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var existing, passwordHash, hostIdNum, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.authService.hashPassword(dto.password)];
                        case 2:
                            passwordHash = _a.sent();
                            hostIdNum = dto.hostId ? BigInt(dto.hostId) : undefined;
                            return [4 /*yield*/, this.prisma.user.create({
                                    ...
                                    select: { id: true, email: true, name: true, role: true, hostId: true, createdAt: true },
                                })];
                        case 3:
                            user = _a.sent();
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (!(dto.password != null)) return [3 /*break*/, 3];
                            _a = data;
                            return [4 /*yield*/, this.authService.hashPassword(dto.password)];
                        case 2:
                            _a.password = _b.sent();
