    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(configService, prisma) {
            var _this = _super.call(this, {
                ...
                secretOrKey: configService.get('JWT_SECRET') || 'fallback-secret-min-32-chars',
            }) || this;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.user.findUnique({
                                ...
                                select: { id: true, email: true, name: true, role: true, hostId: true },
                            })];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                            ...
                            return [2 /*return*/, __assign(__assign({}, user), { sub: user.id })];
                    }
                });
            });
        };
