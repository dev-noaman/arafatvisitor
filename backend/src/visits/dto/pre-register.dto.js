...
exports.PreRegisterVisitDto = void 0;
var class_validator_1 = require("class-validator");
var PreRegisterVisitDto = function () {
    var _a;
    ...
    var _expectedDate_decorators;
    var _expectedDate_initializers = [];
    var _expectedDate_extraInitializers = [];
    return _a = /** @class */ (function () {
            function PreRegisterVisitDto() {
                ...
                this.purpose = (__runInitializers(this, _visitorEmail_extraInitializers), __runInitializers(this, _purpose_initializers, void 0));
                this.expectedDate = (__runInitializers(this, _purpose_extraInitializers), __runInitializers(this, _expectedDate_initializers, void 0));
                __runInitializers(this, _expectedDate_extraInitializers);
            }
            return PreRegisterVisitDto;
        }()),
        (function () {
            ...
            _expectedDate_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsDateString)()];
            ...
            __esDecorate(null, null, _expectedDate_decorators, { kind: "field", name: "expectedDate", static: false, private: false, access: { has: function (obj) { return "expectedDate" in obj; }, get: function (obj) { return obj.expectedDate; }, set: function (obj, value) { obj.expectedDate = value; } }, metadata: _metadata }, _expectedDate_initializers, _expectedDate_extraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
}();
exports.PreRegisterVisitDto = PreRegisterVisitDto;
