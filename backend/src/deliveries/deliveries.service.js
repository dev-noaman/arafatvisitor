...
var DeliveriesService = function () {
    ...
    var DeliveriesService = _classThis = /** @class */ (function () {
        function DeliveriesService_1(prisma) {
            this.prisma = prisma;
        }
        DeliveriesService_1.prototype.normalizeLocation = function (loc) {
        ...
        DeliveriesService_1.prototype.findAll = function (location, search) {
        ...
        DeliveriesService_1.prototype.findMy = function (hostUserId) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        DeliveriesService_1.prototype.create = function (dto, location, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var loc, hostId;
                return __generator(this, function (_a) {
                    loc = this.normalizeLocation(location);
                    hostId = dto.hostId ? BigInt(dto.hostId) : undefined;
        ...
        DeliveriesService_1.prototype.receive = function (id, userId) {
            return __awaiter(this, void 0, void 0, function () {
                var delivery;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (delivery.status === 'RECEIVED') {
                                throw new common_1.BadRequestException('Delivery already received');
                            }
                            return [2 /*return*/, this.prisma.delivery.update({
                                    ...
                                    data: {
                                        status: 'RECEIVED',
                                        receivedAt: new Date(),
                                        receivedById: userId === null || userId === void 0 ? void 0 : userId.toString(),
                                    },
                                    include: { host: true },
                                })];
                    }
