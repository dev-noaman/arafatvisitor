...
var ChangePasswordModal = function (_a) {
    ...
    return (<design_system_1.Box p="xxl" style={{ maxWidth: '400px', margin: '0 auto' }}>
      <design_system_1.H3 mb="xl">Change Password</design_system_1.H3>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <design_system_1.Box mb="lg">
          ...
          <design_system_1.Input type="password" value={newPassword} onChange={function (e) { return setNewPassword(e.target.value); }} placeholder="Enter new password" disabled={loading}/>
        </design_system_1.Box>
        ...
        <design_system_1.Box flex style={{ gap: '12px' }}>
          <design_system_1.Button type="submit" variant="primary" disabled={loading} style={{ flex: 1 }}>
            {loading ? <design_system_1.Loader /> : 'Change Password'}
          </design_system_1.Button>
          {onClose && (<design_system_1.Button type="button" variant="text" onClick={onClose} disabled={loading}>
              Cancel
            </design_system_1.Button>)}
        </design_system_1.Box>
      </form>
